            ...
            <form action="" method="post">
                <table align="center" class="table table-bordered table-hover table-striped" width="100%">
                        ...
                        <tr <?php if(($i%2==0)) echo "class='success'"; else echo "class='danger'";  ?>>
                            ...
                            <td align="center"><input type="checkbox" name="cbitem[]" value="<?php echo $item->user_id;?>" class="checkbox"></td>
                            ...
                            <td align="center"  class="status">
                                    <?php if($item->user_status==1)echo "<i class='glyphicon glyphicon-ok'></i>";?>  
                                    <?php if($item->user_status==2)echo "<i class='glyphicon glyphicon-lock'></i>";?>  
                                    <?php if($item->user_status==0)echo "<i class='glyphicon glyphicon-question-sign'></i>";?>  
                            </td>
                            <td width="33">
                                 <a href="<?php echo $url_admin;?>user/form/<?php echo $item->user_id;?>">
                                <span class="label label-info"> Sửa </span></a>       
                            </td>
                            <td width="39">
                            	<a href="<?php echo $url_admin;?>user/del/<?php echo $item->user_id;?>" onClick="return confirm('Sư huynh có chắc muốn xóa không ?')" ><span class="label label-danger">Xóa</span></a> 
                            </td>
                        </tr>
                        <?php
							}
